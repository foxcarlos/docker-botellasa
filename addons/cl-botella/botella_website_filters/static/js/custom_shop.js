odoo.define('botella_website_filters.customs_shop', function(require){
    'use strict';
    ...
    $(document).on('click', '#load_more_products', function(event){
        ...
        if($("form.js_attributes").length > 0){
            ...
            $("form.js_attributes ul input[name*='variedades']").each(function(){
                if($(this).is(':checked')){
                    temp_attr_variedade_list.push($(this).val())
                }
            });
        }
        var param_dict = {
            ...
            'variedades': temp_attr_variedade_list,
        }
    ...
    $(document).ready(function(){
        ...
        $("#products_grid_before .js_attributes .clear_attr_filter").on("click", function(e){
            ...
            $attr_box.find("input[name='variedades']").each(function(){
                $(this).removeAttr('checked');
            });
